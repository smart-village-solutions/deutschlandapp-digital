      ...
      <div class="grid items-start gap-10 lg:grid-cols-2">
        <div>
          <h2 class="section-title">
            Warum ein föderaler Baukasten besser ist als eine zentrale Einheits‑App
          </h2>
          <p class="section-subtitle">
            Offen, modular, standard‑konform und lokal anpassbar statt starr, teuer und überkomplex.
            Kommunen behalten Souveränität – bei geringeren Kosten und höherer Praxistauglichkeit.
          </p>
          <div class="mt-6 grid gap-4 md:grid-cols-2">
            <div class="compare-card pro">
              <h3 class="mb-1 font-semibold inline-flex items-center gap-2">
                <svg
              ...
              <ul class="pro-list">
                ...
                <li>
                  <span class="dot"></span>Standard‑Schnittstellen (z. B. OParl, DCAT‑AP.de,
                  OAuth/OIDC)
                </li>
        ...
        <div>
          <picture>
            <img
              loading="lazy"
              decoding="async"
              src="https://images.pexels.com/photos/3852577/pexels-photo-3852577.jpeg?auto=compress&cs=tinysrgb&w=1200&h=800&fit=crop"
              alt="Puzzleteile – Sinnbild für modulare Lösungen und passgenaue Kombinationen"
              class="w-full rounded-xl border border-slate-200 object-cover shadow-soft aspect-[4/3]"
            />
          </picture>
        </div>
      </div>
