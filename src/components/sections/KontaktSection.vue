      ...
      <div class="grid items-start gap-8 md:grid-cols-2">
        <div>
          ...
          <p class="section-subtitle">
            Haben Sie Fragen, Anregungen oder möchten Sie die Deutschland.App pilotieren? Wir freuen
          ...
          <p class="mt-3 text-sm text-slate-600">
            Direkt per E‑Mail:
            <a class="link" href="mailto:deutschland.app@smart-village.solutions"
              >deutschland.app@smart-village.solutions</a
            >
          </p>
        </div>
        <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-soft">
          ...
          <ul class="list-disc space-y-2 pl-5 text-slate-700">
            ...
            <li>
              <a
                class="link"
                href="https://initiatived21.de/publikationen/egovernment-monitor-2024/"
                target="_blank"
                rel="noopener"
                >eGovernment MONITOR (2024)</a
              >
            </li>
            <li>
              <a class="link" href="https://www.cima.de/" target="_blank" rel="noopener"
                >CIMA (2022)</a
              >
            </li>
            <li>
            ...
            <li>
              <a class="link" href="https://www.wik.org/" target="_blank" rel="noopener"
                >WIK (2021)</a
              >
            </li>
          </ul>
